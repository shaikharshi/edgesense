...
const SolutionNewsLetter = () => {
    ...
    return (
        <section className='bg-accent-color py-14'>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-between container items-center">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col max-w-sm overflow-hidden">
                    <div className="flex w-full max-w-lg items-center border-[1px] border-white rounded-xl overflow-hidden">
                        <Input
                            type="email"
                            placeholder="Enter Email"
                            {...register("email")}
                            className={` border-0 flex-grow text-white placeholder:text-white ${errors.email ? "border-red-500" : ""}`}
...
export default SolutionNewsLetter
